...
public class MedicoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<DatosRespuestaMedico> lisatrMedicoPorId(@PathVariable Long id) {
...
//     DELETE LOGICO (NO BORRAMOS DE BASE DE DATOS)
    @DeleteMapping("/{id}")
    @Transactional
    ...
    /* DELETE DEFINITIVO, EN BASE DE DATOS
